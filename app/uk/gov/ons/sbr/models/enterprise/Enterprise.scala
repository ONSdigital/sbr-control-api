...
case class Enterprise(
  ...
  @ApiModelProperty(value = "The sum of employees and working proprietors", dataType = "int", example = "101") employment: Int,
  @ApiModelProperty(value = "Geographic region", dataType = "string", example = "E12000001") region: String
)
