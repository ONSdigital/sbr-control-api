...
case class LegalUnit(
  ...
  @ApiModelProperty(value = "Company Reference Number (crn)", dataType = "String", example = "10612", required = false) crn: Option[String],
  ...
  @ApiModelProperty(value = "tradingStatus", dataType = "string", example = "1", required = true) tradingStatus: String,
